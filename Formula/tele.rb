class Tele < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/ardasevinc/tele/releases/download/v#{version}/tele_#{version}_darwin_arm64.tar.gz"
      sha256 "25d58d59d9b0a84f5e74411b1829577380a8ad354847b96514761a74c4613a0f"
    else
      url "https://github.com/ardasevinc/tele/releases/download/v#{version}/tele_#{version}_darwin_amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/ardasevinc/tele/releases/download/v#{version}/tele_#{version}_linux_arm64.tar.gz"
      sha256 "dc559444bf940ddd9f7281c628fcb613eacc8ef46f2fcd924bf2d09d304e4716"
    else
      url "https://github.com/ardasevinc/tele/releases/download/v#{version}/tele_#{version}_linux_amd64.tar.gz"
